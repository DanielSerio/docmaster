...
import { buildDocumentFiltersWhere, type ColumnFilter } from "../utils/filters.js";
import { buildDocumentSortingOrderBy, type ColumnSort } from "../utils/sorting.js";
...
const getAllDocumentsImpl = async ({
  ...
  const where = buildDocumentFiltersWhere(filters);
  const orderBy = buildDocumentSortingOrderBy(sorting);
